...
-- Add rating_change column to match_players (idempotent — may already exist from earlier migration)
ALTER TABLE match_players ADD COLUMN IF NOT EXISTS rating_change INTEGER;
